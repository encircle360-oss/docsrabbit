...
RUN apt-get -y update && apt-get -y --no-install-recommends install tzdata xorg openssl xvfb wget xz-utils bzip2 fontconfig libfreetype6 libjpeg-turbo8 libpng16-16 libx11-6 libxcb1 libxext6 libxrender1 xfonts-75dpi xfonts-base && apt-get -y clean
