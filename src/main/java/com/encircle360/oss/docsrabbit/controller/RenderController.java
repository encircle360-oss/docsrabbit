...
public class RenderController {
    ...
    public ResponseEntity<RenderResultDTO> render(@RequestBody @Valid RenderRequestDTO renderRequestDTO) throws IOException, InterruptedException, TemplateException {
